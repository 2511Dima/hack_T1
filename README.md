# T1 Hackaton!        Suetolog-команда       Состав: Гордиенко Дмитрий
...
Первым шагом было изменение обычного k-среднего на медианы, чтобы избежать выброски данных.

Вторая мысль - разделение данных на 2 больших кластера(можно их заметить на карте), а после использовать метод kmeans вручную.
